...
#define height 500
#define width 400
#define input_image "lion_full.raw"
...
int main()
{
	...
	for (i=0;i<height;i++)
	{
		for (j=0;j<width;j++)
		{
			...
			{
			case 1:
				u = 0 - 2.4851 + (1*co_ordinates[0]) + (0.005*co_ordinates[1]);
				v = 62.1269 + (0*co_ordinates[0]) + (0.8756*co_ordinates[1]);
				break;
			case 2:
				u = 0.0025 + (0.995*co_ordinates[0]) - (0*co_ordinates[1]);
				v = 0 - 0.0622 + (0.1244*co_ordinates[0]) + (1*co_ordinates[1]);
				break;
			case 3:
				u = 0.0017 + (1*co_ordinates[0]) - (0.0034*co_ordinates[1]);
				v = 0 - 0.0419 + (0*co_ordinates[0]) + (1.0839*co_ordinates[1]);
				break;
			case 4:
				u = 0 - 2.0177 + (1.0051*co_ordinates[0]) - (0*co_ordinates[1]);
				v = 50.4419 - (0.1263*co_ordinates[0]) + (1*co_ordinates[1]);
				break;
			}
			i1= height - 0.5 - v;
			j1= u - 0.5;
	...
	const char output_file[] = "lion_wrap.raw";
