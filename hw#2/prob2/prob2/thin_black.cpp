...
#define height 250
#define width 250
#define input_image "Gear_hole.raw"
#define output_image "Gear_hole_thin.raw"

using namespace std;


int thin (unsigned char input_seq, int bond)
{
	unsigned char thin_mask[46] = {  0x12,0x0A,
									 0x48,0x50,0x29,0xE0,0x94,0x07,0xC8,0x49,0x70,0x2A,
...
int main()
{
	...
	for (i = 1; i<height+1; i++)
	{
		for (j=1; j<width+1; j++)
		{
			extended_input[i][j] = (255-output[i-1][j-1])/255;
		}
	}
	...
	unsigned char unconditional_masks[76] ={0x20,0x80, 0x02,0x08, 0x28,0x60,0xC0,0x90,0x14,0x06,
										  ...
										  0x53,0x57,0x4A,0x4E,0x4B,0x4F,0x4A,0xCA,0x6A,0xEA,
